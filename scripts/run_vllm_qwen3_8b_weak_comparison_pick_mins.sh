...
EXACT_K="${EXACT_K:-1}"
NEAREST_EDGE_STRATEGY="${NEAREST_EDGE_STRATEGY:-pick-mins}"

WEAK_COMPARISON_SAMPLE1_MULTIPLIER="${WEAK_COMPARISON_SAMPLE1_MULTIPLIER:-1.0}"
WEAK_COMPARISON_SAMPLE2_MULTIPLIER="${WEAK_COMPARISON_SAMPLE2_MULTIPLIER:-1.0}"
WEAK_COMPARISON_CORRECTNESS_PROBABILITY="${WEAK_COMPARISON_CORRECTNESS_PROBABILITY:-0.85}"
...
cmd=(
  ...
  --weak-comparison-correctness-probability "${WEAK_COMPARISON_CORRECTNESS_PROBABILITY}"
  --weak-comparison-sample1-multiplier "${WEAK_COMPARISON_SAMPLE1_MULTIPLIER}"
  --weak-comparison-sample2-multiplier "${WEAK_COMPARISON_SAMPLE2_MULTIPLIER}"
